...
void protobuf_AssignDesc_Timestamp_2eproto() {
  ...
  static const int Timestamp_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Timestamp, ticks_),
  };
...
#ifndef _MSC_VER
const int Timestamp::kTicksFieldNumber;
#endif  // !_MSC_VER
...
void Timestamp::SerializeWithCachedSizes(
  ...
  // required sfixed64 Ticks = 1;
  if (has_ticks()) {
    ::google::protobuf::internal::WireFormatLite::WriteSFixed64(1, this->ticks(), output);
  }
...
::google::protobuf::uint8* Timestamp::SerializeWithCachedSizesToArray(
  ...
  // required sfixed64 Ticks = 1;
  if (has_ticks()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSFixed64ToArray(1, this->ticks(), target);
  }
